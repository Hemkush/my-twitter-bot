...
# from scraper.techcrunch import fetch_techcrunch_ai
...
def refine_text_for_twitter(input_text):
    """
    Takes existing text, coollect more information and refines it into an optimized tweet using the Gemini API.
    """
    load_dotenv()
    gemini_key = os.getenv("GEMINI_API_KEY")
    ...
    try:
        ...
        1.  The final text MUST be 280 characters or less and more than 150 characters.
        2.  Collect more information and refine the text to be more concise, clear, and impactful.
...
def refine_text_for_reddit(input_text):
    """
    Takes existing text, coollect more information and refines it into an optimized reddit post using the Gemini API.
    """
    load_dotenv()
    gemini_key = os.getenv("GEMINI_API_KEY")
    ...
    try:
        ...
        Your response MUST follow these rules:
        1.  The final text MUST be 300 characters or less and more than 150 characters.
        2.  Collect more information and refine the text to be more concise, clear, and impactful. Ideal for asking questions, sharing opinions, telling stories, starting discussions, or providing detailed explanations.
        3.  Add 3-5 relevant and popular hashtags to maximize reach and Flair.
        4.  If appropriate, include hashtags that represent relevant communities (e.g., #buildinpublic, #100DaysOfCode, #techtwitter).
        5.  Do NOT add any commentary, explanations, or labels. Your output must be ONLY the final tweet text.
